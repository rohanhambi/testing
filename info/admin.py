...
from .models import AttendanceTotal, StudentCourse, Marks, MarksClass, User,Sem
...
class SemAdmin(ImportExportModelAdmin):
    list_display = ('studentcourse',)
    search_fields = ('studentcourse',)
    ordering = ['studentcourse',]
    exclude = ('results',)
